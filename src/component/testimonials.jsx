    ...
    return (
        <>
            ...
            <div className='testimonial-card-container mb-5'>
                ...
                <Card name="Mohd Faraz" message="this is description we need to change like all content indide that" image="assest/image/user.png" />
                ...
                <Card name="Mohd Sayam" message="this is description we need to change like all content indide that" image="assest/image/user.png" />
                <Card name="Mohd Daniyal" message="this is description we need to change like all content indide that" image="assest/image/user.png" />
            </div>
        </>
    );
}
